          ...
          <view class="carnum acea-row row-left">
            ...
            <view
              ...
              :class="
                ...
                (limitNum && attr.productSelect.cart_num >= limitNum)
                  ? 'on'
                  : ''
              "
              @click="CartNumAdd"
            ...
            <view
              ...
              :class="
                ...
                attr.productSelect.cart_num >=
                  attr.productSelect.product_stock ||
                attr.productSelect.cart_num >= attr.productSelect.num ||
                (type == 'seckill' &&
                  attr.productSelect.cart_num >= attr.productSelect.once_num)
                  ? 'on'
                  : ''
              "
              @click="CartNumAdd"
